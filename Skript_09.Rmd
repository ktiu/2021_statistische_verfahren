...
kable(rbind(head(rad), data.frame(x=c("..."="..."), y=c("..."="...")), tail(rad)), "latex", row.names=T, booktabs=T, longtable=F, linesep="", caption = "\\label{tab:roh}Ungeordnete Rohdaten der Erhebung", col.names = c("Studienfach", "Transportmittel")) %>%
...
kable(t, "latex", booktabs=T, escape=F, longtable=F, col.names = c("Spalte 1","Spalte 2", "...", "Spalte $\\ell$", ""), caption = "Allgemeine Bezeichnungen in der Kreuztabelle") %>%
  kable_styling() %>%
...
xt$df %>% kable_styling(latex_options = c("hold_position"))
