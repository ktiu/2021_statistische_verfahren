...
## 2-Stichproben-`r symbol_header("t")`-Test {#2-stichproben-t-test}
...
```{r}
rtip("In R wird auch der 2-Stichproben-$t$-Test mit dem Befehl `t.test()` durchgeführt. Im Gegensatz zum 1-Stichproben-$t$-Test werden dabei zwei Verteilungen als Argumente eingegeben.")
```
