...
```{r crossrad}
get_crosstable(rad,
               row_order = c("Geistes-/Sozialwissenschaft",
                             "anderes Studienfach"),
               col_order = c("Fahrrad", "anderes Transportmittel")) -> xt_rad
...
tibble(
  ...
  get_crosstable(col_order = c("Fahrrad",
                               "Auto",
                               "Öffentliche"),
                 row_order = c("Geisteswissenschaft",
                               "Sozialwissenschaft",
                               "Naturwissenschaft",
