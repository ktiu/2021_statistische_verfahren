...
tribble(
  ~Schritt, ~Musterlösung, ~Punkte, ~Implizit,
  "Varianz: Formel", var_b$formel, 0, T,
  "Varianz: Einsetzen", var_b$einsetzen, 0, T,
  "Varianz: Ergebnis", var_b$ergebnis, 0, T,
  "Standardabweichung: Formel", sd_b$formel, 0, T,
  "Standardabweichung: Einsetzen", sd_b$einsetzen, 0, T,
  "Varianz: Ergebnis", sd_b$ergebnis, 0, T,
) %>% lectuR::solution_table(meta = F)
```
...
tribble(
  ~Schritt, ~Musterlösung, ~Punkte, ~Implizit,
  "Varianz: Formel", var_c$formel, 0, T,
  "Varianz: Einsetzen", var_c$einsetzen, 0, T,
  "Varianz: Ergebnis", var_c$ergebnis, 0, T,
  "Standardabweichung: Formel", sd_c$formel, 0, T,
  "Standardabweichung: Einsetzen", sd_c$einsetzen, 0, T,
  "Varianz: Ergebnis", sd_c$ergebnis, 0, T,
) %>% lectuR::solution_table(meta = F)
```
...
tabelle(df, escape = F, col.names = c("$x_i$", "$f_i$", "$f_i\\cdot x_i$", "$(x_i-\\bar{x})$", "$(x_i-\\bar{x})^2$", "$f_i\\cdot(x_i-\\bar{x})^2$"))
```
...
tbbl %>%
  select(x, k, f, fkum) %>%
  tabelle(col.names = c("$x$", "$k_i$", "$f_i$", "$f_{kum}$"))
```
...
tbbl %>%
  ...
  tabelle(col.names = c("$x$", "$k_i$", "$f_i$", "$f_{kum}$", "$f_i \\cdot k_i$"))
```
...
tbbl %>%
  ...
  tabelle(col.names = c("$x_i$", "$k_i$", "$f_i$", "$(k_i - \\bar{x})$", "$(k_i - \\bar{x})^2$", "$f_i \\cdot (k_i - \\bar{x})^2$"))
```
...
tribble(
  ~Schritt, ~Musterlösung, ~Punkte, ~Implizit,
  "Formel", lectuR::get_mean()$formel, 1, F,
