...
Damit lässt sich der kritische Wert aus der [Formelsammlung](#formeln) ablesen, die allerdings für *ungerichtete* Alternativhypothesen ausgelegt ist.
...
```{r late, eval = T}
tibble("Wochentag" = c(rep("Montag",     459),
                       rep("Dienstag",   409),
                       rep("Mittwoch",   414),
                       rep("Donnerstag", 387),
                       rep("Freitag",    437))) %>%
  get_crosstable(row_order = c("Montag", "Dienstag", "Mittwoch",
                               "Donnerstag", "Freitag")) -> verspaetungen

print_crosstable(verspaetungen, question = T,
...
Der kritische Wert für den Ablehnungsbereich ist der [Formelsammlung](#formeln) zu entnehmen.
