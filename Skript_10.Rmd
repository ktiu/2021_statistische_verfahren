...
zivixt <- crosstable(zivi, format="latex", varnames = F, caption = "Kreuztabelle der Beispieldaten")
zivixt$df
```
...
\\makecell[tr]{459\\\\(421,2)\\\\\\color{goethe_blue}{3,392}} \\makecell[tr]{409\\\\(421,2)\\\\\\color{goethe_blue}{0,353}} \\makecell[tr]{414\\\\(421,2)\\\\\\color{goethe_blue}{0,123}} \\makecell[tr]{387\\\\(421,2)\\\\\\color{goethe_blue}{2,777}} \\makecell[tr]{437\\\\(421,2)\\\\\\color{goethe_blue}{0,593}} 2106") %>%
  kable("latex", escape=F, booktabs=T, longtable=F, col.names=c("Montag", "Dienstag", "Mittwoch", "Donnerstag", "Freitag", " "), caption = "Tabelle für den $\\chi^2$-Anpassungstest") %>%
  kable_styling() %>%
