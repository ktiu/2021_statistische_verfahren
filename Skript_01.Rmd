...
c("Nominalskala", "Postleitzahl", "Gleichheit, Verschiedenheit", "Modus",
  ...
  as_tibble %>%
  kable("latex", booktabs=T, col.names= c("Skalenart", "Beispiel", "Mögliche Aussagen", "gültige Lagemaße"), caption="Die vier wichtigsten Skalenniveaus.") %>%
  kable_styling() 
```
...
kable(df, "latex", booktabs=T, escape=F, caption = "Tabelle mit kumulierten Häufigkeiten", linesep = "" ,align = "lrrrr")
```
...
knitr::kable(df, "latex", booktabs=T, escape=F, linesep="", caption = "Häufigkeitstabelle mit klassierten Werten",align = "lrrrr") %>%
  kable_styling()
