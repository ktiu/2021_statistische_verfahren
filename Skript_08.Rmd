...
<div class="rtip_content">Wenn in R ein lineares Modell (eine Regressionsgerade) vorliegt, können Werte mit `predict()` geschätzt werden.</div>
...
<div class="rtip">Softwarehinweis</div>
<div class="rtip_content">In R lässt sich ein lineares Regressionsmodell mit dem Befehl `lm()` erstellen.</div>
...
<div class="rtip">Softwarehinweis</div>
<div class="rtip_content">Residuen lassen sich in R durch den Befehl `resid()` errechnen.</div>
...
<div class="rtip">Softwarehinweis</div>
<div class="rtip_content">In R wird mit dem Befehl `summary()` unter anderem der Determinationskoeffizient eines linearen Regressionsmodells ausgegeben.</div>
