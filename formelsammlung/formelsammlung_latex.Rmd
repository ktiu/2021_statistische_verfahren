...
```{r zcurve, fig.width=3, fig.height=1.5, fig.align='center'}
lectuR::draw.curve(
  interval = c(-3,3),
  colorf = c(-3,1.2),
  xlabel = "z",
...
## $t$-Verteilungen {.unnumbered #tabelle-t}

\begin{multicols}{2}
\vfill

```{r tcurve, fig.width=3, fig.height=1.4, fig.align='center'}
lectuR::draw.curve(
  interval = c(-4,4),
  colorf = c(-4,2),
  xlabel = "t",
...
## $F$-Verteilungen {.unnumbered #tabelle-f}

\begin{multicols}{2}
\vfill

```{r fcurve, fig.width=3, fig.height=1.5, fig.align='center'}
lectuR::draw.curve(
  interval = c(0, 4),
  colorf   = c(0, 2.34),
  xlabel   = "F",
...
## $\chi^2$-Verteilungen {.unnumbered #tabelle-chisq}


```{r chisqcurve, fig.height = 2, fig.width = 5, out.width = '0.49\\linewidth', fig.align = 'center'}
lectuR::draw.curve(
  interval = c(0, 24),
  colorf = c(0, 15),
  xlabel = "$\\chi^2$",
