...
Für die Standardnormalverteilung finden sich die $p$-Werte für positive $z$ in der [Formelsammlung](Formelsammlung und Wertetabellen.pdf).^[Manchmal wird die Funktion $z_p \rightarrow P(z < z_p)$ für normalverteilte Werte auch mit $\Phi(z)$ bezeichnet [z.B. in @bahrenberg].]
...
Die [Formelsammlung](Formelsammlung und Wertetabellen.pdf) gibt für $z$-Werte die Wahrscheinlichkeit ihrer Unterschreitung in ener Normalverteilung an. Diese Wahrscheinlichkeit kann notiert werden als $P(z<z_p)$.

Der [Formelsammlung](Formelsammlung und Wertetabellen.pdf) können wir den Wert $P(z < 1,41) \approx 0,9207$ entnehmen. Die Wahrscheinlichkeit, dass der Luftdruck zu einem zufälligen Zeitpunkt weniger als 1015 hPA beträgt, ist somit 92,07%.
...
Die [Formelsammlung](Formelsammlung und Wertetabellen.pdf) enthält keine $p$ für negative $z_p$. Da die Standardnormalverteilung jedoch um $z=0$ symmetrisch ist, gilt ganz allgemein:
...
Dann können wir die entsprechende Wahrscheinlichkeit berechnen, indem wir wieder die Werte aus der [Formelsammlung](Formelsammlung und Wertetabellen.pdf) einsetzen:
